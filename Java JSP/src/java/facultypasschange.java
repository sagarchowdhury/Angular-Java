...
public class facultypasschange extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String current = request.getParameter("password");
        String change = request.getParameter("apassword");
        ...
        try
        {
            ...
            String str = "select count(*) as colname from faculty where facultyID = '"+userid+"' and password='"+newcurrent+"'";
            ...
            if(a==1)
            {
                String query="UPDATE faculty SET password='"+newchange+"' WHERE password='"+newcurrent+"' AND facultyID='"+userid+"'";
