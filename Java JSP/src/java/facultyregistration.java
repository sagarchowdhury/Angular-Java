...
public class facultyregistration extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try
        {
            ...
            String newpassword=new BASE64Encoder().encode(hashvalue);
            Config c = new Config();
            Connection con = c.getcon();
            Statement st = con.createStatement();
            String qry = "select count(*) as col from faculty where facultyid ='"+username+"'";
            ...
            if(check==0)
            {
                ...
                String query="insert into faculty values('"+name+"','"+username+"','"+newpassword+"','"+institute+"','"+email+"','"+number+"','"+dob+"','"+sex+"',"+flag+",'"+code+"')";
