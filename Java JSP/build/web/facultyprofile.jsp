...
<%
            ...
            {
                   out.println("<b> Welcome , <a href='facultyprofile.jsp' style='color:white'>" +username+ "</a></b>");
            }
%>
&nbsp;&nbsp;
...
<form  action ='<%= response.encodeURL("facultypasschange") %>' id="contact-form4" class="form-horizontal" method="post">
						    ...
						    <div class="control-group">
						      ...
						      <div class="controls">
                                                          <div class="input-prepend">
                                                        <span class="add-on"><i class="icon-book"></i></span>
                                                        <input type="password" class="input-large" name="password" id="password" placeholder="Current Password" required="true" onkeyup="loadXMLDoc()"/>
                                                              <span id="err"> </span>
                                                          </div>
                                                      </div>
						    </div>
                                                    <div class="control-group">
                                                                              <label class="control-label" for="apassword">New Password</label>
                                                                              <div class="controls">
                                                                                  <div class="input-prepend">
                                                        <span class="add-on"><i class="icon-barcode"></i></span>
                                                                                <input type="password" class="input-large" name="apassword" id="apassword" required="true" placeholder="New Password"/>
                                                                              </div>
                                                                            </div>
                                                    </div>
                                                                                <div class="control-group">
                                                                              <label class="control-label" for="conpassword">Re Password</label>
                                                                              <div class="controls">
                                                                                  <div class="input-prepend">
                                                        <span class="add-on"><i class="icon-barcode"></i></span>
                                                                                <input type="password" class="input-large" name="conpassword" id="conpassword" required="true" placeholder="New Password"/>
                                                                              </div>
                                                                            </div>
                                                    </div>
